...
import "./App.css";
import BarLineChart from "./components/BarLine";
    ...
    <ChartThemeProvider themeMode={activeMode}>
      <>
        <div
          style={{
            ...
            borderRadius: "8px",
            width: "fit-content",
            background: activeMode === "dark" ? "#2a3854" : "#e8f0fb",
          }}
        >
          <button
            ...
            style={{
              ...
              borderRadius: "6px",
              border: "none",
              background: activeMode === "light" ? "#407abc" : "#e0e0e0",
              color: activeMode === "light" ? "white" : "#333",
              fontWeight: activeMode === "light" ? "bold" : "normal",
              cursor: "pointer",
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "6px",
              border: "none",
              background: activeMode === "dark" ? "#407abc" : "#e0e0e0",
              color: activeMode === "dark" ? "white" : "#333",
              fontWeight: activeMode === "dark" ? "bold" : "normal",
              cursor: "pointer",
              transition: "all 0.3s ease",
            }}
          >
...

      {
        <Sortable className="my-cards">
          ...
          <SortableCard title="BarLineChart" height={400} width={"100%"}>
            <BarLineChart
              data={{
          ...
          <SortableCard title="VerticalBarChart" height={400} width={"100%"}>
            <VerticalBarChart
              data={[
          ...
          <SortableCard title="HorizontalBarChart" height={400} width={"100%"}>
            <HorizontalBarChart
              data={[
            ...
            <VerticalStackedBarChart
              data={[
                ...new Array(10).fill(0).map((_, index) => ({
                  ...
                  data: {
                    future: Math.floor(Math.random() * 100000) + 20,
                    options: Math.floor(Math.random() * 100000) + 20,
                    forwards: Math.floor(Math.random() * 100000) + 20,
                    fixedIncome: Math.floor(Math.random() * 100000) + 20,
                    others: Math.floor(Math.random() * 100000) + 20,
                  },
                })),
              ]}
              groupKeys={[
            ...
            <HorizontalStackedBarChart
              data={[
                ...new Array(10).fill(0).map((_, index) => ({
                  ...
                  data: {
                    payroll: Math.floor(Math.random() * 50000) + 20000,
                    equipment: Math.floor(Math.random() * 15000) + 5000,
                    software: Math.floor(Math.random() * 10000) + 3000,
                    travel: Math.floor(Math.random() * 6000) + 2000,
                  },
                })),
              ]}
          ...
          <SortableCard title="Asset Allocation" height={80} width={"100%"}>
            <TreeMapChart
              data={{
                id: "portfolio",
                name: "Portfolio",
          ...
          <SortableCard title="Market Analysis" height={500} width={400}>
            <TreeMapChart
              data={{
                id: "markets",
                name: "Global Markets",
              ...
              timestamp={new Date().toISOString()}
              colors={["#407abc", "#50c1c2", "#fad176", "#93a3bc"]}
              isLoading={isLoading}
              titleProps={{
                variant: "h6",
                align: "left",

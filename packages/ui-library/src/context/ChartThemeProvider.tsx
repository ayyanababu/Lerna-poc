    ...
    () => ({
      colors: {
        ...
        charts: {
          ...
          bar:
            themeOverrides?.colors?.charts?.bar || baseTheme.colors.charts.bar,
          stackedBar:
            themeOverrides?.colors?.charts?.stackedBar ||
            baseTheme.colors.charts.stackedBar,
          line:
            themeOverrides?.colors?.charts?.line ||
            baseTheme.colors.charts.line,
          area:
            themeOverrides?.colors?.charts?.area ||
            baseTheme.colors.charts.area,
          treemap:
            themeOverrides?.colors?.charts?.treemap ||
            baseTheme.colors.charts.treemap,
          donut:
            themeOverrides?.colors?.charts?.donut ||
            baseTheme.colors.charts.donut,
          pie:
            themeOverrides?.colors?.charts?.pie || baseTheme.colors.charts.pie,
          scatter:
            themeOverrides?.colors?.charts?.scatter ||
            baseTheme.colors.charts.scatter,
        },
      },
    }),
